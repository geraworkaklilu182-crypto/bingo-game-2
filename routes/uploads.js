...
// User middleware (for regular authenticated users)
...
// Upload screenshot (for deposit requests - any authenticated user)
router.post('/screenshot', verifyToken, upload.single('image'), async (req, res) => {
    try {
        if (!req.file) {
